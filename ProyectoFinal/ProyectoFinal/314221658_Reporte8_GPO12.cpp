...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 0.75f, 0.75f, 0.75f);
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, lightPos + glm::vec3(movelightPosX, movelightPosY, movelightPosZ));
